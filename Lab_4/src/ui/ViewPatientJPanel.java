...
public class ViewPatientJPanel extends javax.swing.JPanel {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String blood_pressure = model.getValueAt(selectedRowIndex, 9).toString();
        String Report = model.getValueAt(selectedRowIndex, 10).toString();
...
//        model.setValueAt(newDateOfVisist, selectedRowIndex, 2);
        ...
        pd.setUnique_id(Integer.parseInt(patient_id));
        pd.setDate_of_visit(date_of_visit);
